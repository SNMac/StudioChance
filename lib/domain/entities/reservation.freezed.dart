...
mixin _$Reservation {
 ...
 String get id; Store get store; StoreMemberInfo get writer; ReservationStatus get status; String get customerName; int get headCount; String get customerPhone; String get memo; DateTime get startTime; DateTime get endTime; String get platform; String get paymentMethod; int get calculatedPrice; int get priceAdjustment; int get totalPrice;
...
@override
int get hashCode => Object.hash(runtimeType,id,store,writer,status,customerName,headCount,customerPhone,memo,startTime,endTime,platform,paymentMethod,calculatedPrice,priceAdjustment,totalPrice);

@override
String toString() {
  return 'Reservation(id: $id, store: $store, writer: $writer, status: $status, customerName: $customerName, headCount: $headCount, customerPhone: $customerPhone, memo: $memo, startTime: $startTime, endTime: $endTime, platform: $platform, paymentMethod: $paymentMethod, calculatedPrice: $calculatedPrice, priceAdjustment: $priceAdjustment, totalPrice: $totalPrice)';
}
...
@useResult
$Res call({
 String id, Store store, StoreMemberInfo writer, ReservationStatus status, String customerName, int headCount, String customerPhone, String memo, DateTime startTime, DateTime endTime, String platform, String paymentMethod, int calculatedPrice, int priceAdjustment, int totalPrice
});


$StoreCopyWith<$Res> get store;$StoreMemberInfoCopyWith<$Res> get writer;
...
/// Create a copy of Reservation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? store = null,Object? writer = null,Object? status = null,Object? customerName = null,Object? headCount = null,Object? customerPhone = null,Object? memo = null,Object? startTime = null,Object? endTime = null,Object? platform = null,Object? paymentMethod = null,Object? calculatedPrice = null,Object? priceAdjustment = null,Object? totalPrice = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,store: null == store ? _self.store : store // ignore: cast_nullable_to_non_nullable
as Store,writer: null == writer ? _self.writer : writer // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  Store store,  StoreMemberInfo writer,  ReservationStatus status,  String customerName,  int headCount,  String customerPhone,  String memo,  DateTime startTime,  DateTime endTime,  String platform,  String paymentMethod,  int calculatedPrice,  int priceAdjustment,  int totalPrice)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reservation() when $default != null:
return $default(_that.id,_that.store,_that.writer,_that.status,_that.customerName,_that.headCount,_that.customerPhone,_that.memo,_that.startTime,_that.endTime,_that.platform,_that.paymentMethod,_that.calculatedPrice,_that.priceAdjustment,_that.totalPrice);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  Store store,  StoreMemberInfo writer,  ReservationStatus status,  String customerName,  int headCount,  String customerPhone,  String memo,  DateTime startTime,  DateTime endTime,  String platform,  String paymentMethod,  int calculatedPrice,  int priceAdjustment,  int totalPrice)  $default,) {final _that = this;
switch (_that) {
case _Reservation():
return $default(_that.id,_that.store,_that.writer,_that.status,_that.customerName,_that.headCount,_that.customerPhone,_that.memo,_that.startTime,_that.endTime,_that.platform,_that.paymentMethod,_that.calculatedPrice,_that.priceAdjustment,_that.totalPrice);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  Store store,  StoreMemberInfo writer,  ReservationStatus status,  String customerName,  int headCount,  String customerPhone,  String memo,  DateTime startTime,  DateTime endTime,  String platform,  String paymentMethod,  int calculatedPrice,  int priceAdjustment,  int totalPrice)?  $default,) {final _that = this;
switch (_that) {
case _Reservation() when $default != null:
return $default(_that.id,_that.store,_that.writer,_that.status,_that.customerName,_that.headCount,_that.customerPhone,_that.memo,_that.startTime,_that.endTime,_that.platform,_that.paymentMethod,_that.calculatedPrice,_that.priceAdjustment,_that.totalPrice);case _:
  return null;
...
class _Reservation implements Reservation {
  const _Reservation({required this.id, required this.store, required this.writer, required this.status, required this.customerName, required this.headCount, required this.customerPhone, required this.memo, required this.startTime, required this.endTime, required this.platform, required this.paymentMethod, required this.calculatedPrice, required this.priceAdjustment, required this.totalPrice});
...
@override $StoreCopyWith<$Res> get store;@override $StoreMemberInfoCopyWith<$Res> get writer;
...
/// Create a copy of Reservation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? store = null,Object? writer = null,Object? status = null,Object? customerName = null,Object? headCount = null,Object? customerPhone = null,Object? memo = null,Object? startTime = null,Object? endTime = null,Object? platform = null,Object? paymentMethod = null,Object? calculatedPrice = null,Object? priceAdjustment = null,Object? totalPrice = null,}) {
