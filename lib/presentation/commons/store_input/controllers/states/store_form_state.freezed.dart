...
mixin _$StoreFormState {
 ...
 String get name; String get address; String get addressDetail; String get addressGuide; String get memo; StoreColor get color; PriceSetting get priceSettings; String get bankName; String get bankAccountNumber; String get bankAccountHolder; int? get paymentDeadlineMinutes; AsyncValue<void> get status;
...
@useResult
$Res call({
 String name, String address, String addressDetail, String addressGuide, String memo, StoreColor color, PriceSetting priceSettings, String bankName, String bankAccountNumber, String bankAccountHolder, int? paymentDeadlineMinutes, AsyncValue<void> status
});
...
/// Create a copy of StoreFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? address = null,Object? addressDetail = null,Object? addressGuide = null,Object? memo = null,Object? color = null,Object? priceSettings = null,Object? bankName = null,Object? bankAccountNumber = null,Object? bankAccountHolder = null,Object? paymentDeadlineMinutes = freezed,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String address,  String addressDetail,  String addressGuide,  String memo,  StoreColor color,  PriceSetting priceSettings,  String bankName,  String bankAccountNumber,  String bankAccountHolder,  int? paymentDeadlineMinutes,  AsyncValue<void> status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StoreFormState() when $default != null:
return $default(_that.name,_that.address,_that.addressDetail,_that.addressGuide,_that.memo,_that.color,_that.priceSettings,_that.bankName,_that.bankAccountNumber,_that.bankAccountHolder,_that.paymentDeadlineMinutes,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String address,  String addressDetail,  String addressGuide,  String memo,  StoreColor color,  PriceSetting priceSettings,  String bankName,  String bankAccountNumber,  String bankAccountHolder,  int? paymentDeadlineMinutes,  AsyncValue<void> status)  $default,) {final _that = this;
switch (_that) {
case _StoreFormState():
return $default(_that.name,_that.address,_that.addressDetail,_that.addressGuide,_that.memo,_that.color,_that.priceSettings,_that.bankName,_that.bankAccountNumber,_that.bankAccountHolder,_that.paymentDeadlineMinutes,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String address,  String addressDetail,  String addressGuide,  String memo,  StoreColor color,  PriceSetting priceSettings,  String bankName,  String bankAccountNumber,  String bankAccountHolder,  int? paymentDeadlineMinutes,  AsyncValue<void> status)?  $default,) {final _that = this;
switch (_that) {
case _StoreFormState() when $default != null:
return $default(_that.name,_that.address,_that.addressDetail,_that.addressGuide,_that.memo,_that.color,_that.priceSettings,_that.bankName,_that.bankAccountNumber,_that.bankAccountHolder,_that.paymentDeadlineMinutes,_that.status);case _:
  return null;
...
class _StoreFormState extends StoreFormState {
  const _StoreFormState({this.name = '', this.address = '', this.addressDetail = '', this.addressGuide = '', this.memo = '', this.color = StoreColor.red, required this.priceSettings, this.bankName = '', this.bankAccountNumber = '', this.bankAccountHolder = '', this.paymentDeadlineMinutes, this.status = const AsyncData(null)}): super._();
...
/// Create a copy of StoreFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? address = null,Object? addressDetail = null,Object? addressGuide = null,Object? memo = null,Object? color = null,Object? priceSettings = null,Object? bankName = null,Object? bankAccountNumber = null,Object? bankAccountHolder = null,Object? paymentDeadlineMinutes = freezed,Object? status = null,}) {
