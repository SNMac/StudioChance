...
mixin _$StoreFormState {
 ...
 String get name; String get address; String get memo; StoreColor get color;// 복잡한 객체는 nullable로 두거나, 기본값을 상수로 정의해서 넣어줌
...
@override
int get hashCode => Object.hash(runtimeType,name,address,memo,color,priceSettings,status);

@override
String toString() {
  return 'StoreFormState(name: $name, address: $address, memo: $memo, color: $color, priceSettings: $priceSettings, status: $status)';
}
...
@useResult
$Res call({
 String name, String address, String memo, StoreColor color, PriceSetting priceSettings, AsyncValue<void> status
});
...
/// Create a copy of StoreFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? address = null,Object? memo = null,Object? color = null,Object? priceSettings = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String address,  String memo,  StoreColor color,  PriceSetting priceSettings,  AsyncValue<void> status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StoreFormState() when $default != null:
return $default(_that.name,_that.address,_that.memo,_that.color,_that.priceSettings,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String address,  String memo,  StoreColor color,  PriceSetting priceSettings,  AsyncValue<void> status)  $default,) {final _that = this;
switch (_that) {
case _StoreFormState():
return $default(_that.name,_that.address,_that.memo,_that.color,_that.priceSettings,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String address,  String memo,  StoreColor color,  PriceSetting priceSettings,  AsyncValue<void> status)?  $default,) {final _that = this;
switch (_that) {
case _StoreFormState() when $default != null:
return $default(_that.name,_that.address,_that.memo,_that.color,_that.priceSettings,_that.status);case _:
  return null;
...
class _StoreFormState extends StoreFormState {
  const _StoreFormState({this.name = '', this.address = '', this.memo = '', this.color = StoreColor.red, required this.priceSettings, this.status = const AsyncValue.data(null)}): super._();
...
/// Create a copy of StoreFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? address = null,Object? memo = null,Object? color = null,Object? priceSettings = null,Object? status = null,}) {
