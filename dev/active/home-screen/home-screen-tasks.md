...
- [ ] **18-3**: 오늘 버튼 후 스크롤 → 인접 날짜 스크롤 위치 불일치
...
- [ ] 시간열↔날짜열 구분선이 종일 영역 안쪽부터 시작 (18-1)
- [ ] 날짜 열 구분선이 헤더 행 아래부터 시작 (18-2)
- [ ] 오늘 버튼 후 인접 날짜 스크롤 위치 동기화 (18-3)
