...
argument-hint: Describe what you need planned (e.g., "refactor authentication system", "implement reservation feature")
---
...
- Reference existing code patterns in lib/ directory
